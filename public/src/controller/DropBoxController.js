...
class DropBoxController {
    ...
    connectFirebase(){
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyApq6zOHj8pfFrknSNt17jh3NM2mnnViNo",
            authDomain: "dropbox-clone-f65a3.firebaseapp.com",
            databaseURL: "https://dropbox-clone-f65a3-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-f65a3",
            storageBucket: "dropbox-clone-f65a3.appspot.com",
            messagingSenderId: "993121792505",
            appId: "1:993121792505:web:10191131fbfb014f9b4d28",
            measurementId: "G-F62SHVGJ9Y"
          };
    ...
    uploadProgress(event, file){
        ...
        this.fileNameEl.innerHTML = file.originalFilename;
    ...
    renderNav(){
        ...
        this.navEl.querySelectorAll('a').forEach(a=>{
            ...
            a.addEventListener('click', e=>{
                ...
                this.currentFolder = a.dataset.filepath.split('/');
    ...
    initEventsLi(li){
        ...
        li.addEventListener('dblclick', e=>{
            ...
            switch (file.type) {
                ...
                default:
                    window.open('/files?path=' + file.filepath);
